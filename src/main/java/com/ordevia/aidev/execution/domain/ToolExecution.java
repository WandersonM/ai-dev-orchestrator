...
@Entity
@Table(name = "tool_execution", uniqueConstraints = @UniqueConstraint(name = "uk_tool_execution_work_item_step", columnNames = {"work_item_id", "agent_type", "step_number"}))
public class ToolExecution {
    ...
    @Column(name = "agent_type", nullable = false, length = 60)
    ...
    public void succeed(String outputText) {
        finish(ToolExecutionStatus.SUCCEEDED, outputText, null);
    }

    public void fail(String errorMessage) {
        finish(ToolExecutionStatus.FAILED, null, errorMessage);
    }
